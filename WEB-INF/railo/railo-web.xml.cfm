<?xml version="1.0" encoding="UTF-8"?><railo-configuration password="e50dbcb24ce6e2575cf6a36d148c829ac77310c55336744e05c6d4b4c6852e00b7bfc9cd8f0c7685" version="2.0"><cfabort/>
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" blob="false" class="org.gjt.mm.mysql.Driver" clob="false" connectionTimeout="1" custom="characterEncoding=UTF-8&amp;useUnicode=true" database="emilydev" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" metaCacheTimeout="60000" name="emilydev" port="3306" storage="false" username="root" validate="false"/></data-sources>
...
<ext-tags><ext-tag class="railo.cfx.example.HelloWorld" name="HelloWorld" type="java"/></ext-tags></railo-configuration>